...
export function UMKMView() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-primary/3 to-background flex">
      ...
      <aside className="hidden lg:flex flex-col w-72 fixed left-0 top-16 bottom-0 z-40">
        ...
        {sidebarOpen && (
          <>
            ...
            <motion.aside
              ...
              className="lg:hidden fixed left-0 top-16 bottom-0 w-72 z-50 bg-sidebar/95 backdrop-blur-xl border-r border-sidebar-border/50 shadow-2xl"
            >
