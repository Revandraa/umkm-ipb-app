        ...
        <div className="bg-gradient-to-br from-primary/10 to-primary/5 -mx-6 px-6 py-8 mb-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              <DialogTitle className="text-2xl font-bold text-foreground mb-2">{umkm.name}</DialogTitle>
              <DialogDescription className="sr-only">Detail dan menu dari UMKM {umkm.name}</DialogDescription>
